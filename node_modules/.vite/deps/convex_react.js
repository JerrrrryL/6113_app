...
function convexToJsonInternal(value, originalValue, context) {
  ...
  if (!isObject || !isSimple) {
    const theType = (_a = value == null ? void 0 : value.constructor) == null ? void 0 : _a.name;
...
var fetch2 = globalThis.fetch || ((...args) => import("./lib-DTUVW4JO.js").then(
...
// node_modules/convex/dist/esm/react/index.js
if (typeof import_react7.default === "undefined") {
...
var ConvexContext = import_react7.default.createContext(
  void 0
);
function useConvexGeneric() {
  return (0, import_react7.useContext)(ConvexContext);
}
...
function useQueryGeneric(name, ...args) {
  const convex = (0, import_react7.useContext)(ConvexContext);
  if (convex === void 0) {
    throw new Error(
...
function useQueryInternal(convex, name, ...args) {
  const subscription = (0, import_react7.useMemo)(
    () => {
...
function useMutationGeneric(name) {
  ...
  return (0, import_react7.useMemo)(() => convex.mutation(name), [convex, name]);
}
function useActionGeneric(name) {
  ...
  return (0, import_react7.useMemo)(() => convex.action(name), [convex, name]);
}
